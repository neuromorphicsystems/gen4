...
static PyMethodDef evk4_recorder_3d_extension_methods[] = {{nullptr, nullptr, 0, nullptr}};
static struct PyModuleDef evk4_recorder_3d_extension_definition = {
    PyModuleDef_HEAD_INIT,
    "evk4_recorder_3d_extension",
    "evk4_recorder_3d_extension reads events from a Prophesee Gen 4 dev kit 1.3 (Denebola)",
    -1,
    evk4_recorder_3d_extension_methods};
PyMODINIT_FUNC PyInit_evk4_recorder_3d_extension() {
    auto module = PyModule_Create(&evk4_recorder_3d_extension_definition);
    import_array();
    camera_type.tp_name = "evk4_recorder_3d_extension.Camera";
